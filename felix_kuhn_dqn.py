...
"""DQN agents trained on Kuhn poker by independent Q-learning."""
...
# Training parameters
flags.DEFINE_string("checkpoint_dir", "/tmp/kuhn_dqn/",
  ...
  with tf.Session() as sess:
    ...
    for ep in range(FLAGS.num_train_episodes):
      if (ep + 1) % FLAGS.eval_every == 0:
        ...
        print(exploitability.nash_conv(game, agent[0].average_policy()))
      time_step = env.reset()
      # Randomize position.
      if FLAGS.randomize_positions:
